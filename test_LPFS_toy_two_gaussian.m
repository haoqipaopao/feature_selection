...
interval = [0.7 0.75 0.9;0.45,0.8,0.9;0.4,0.6,0.9];
idx=3;
m=3;
if newdata == 1
    num0 = 400;
    [X, Y,n1] = twogaussian_three_dimension_gen(num0,interval(m,idx), 0.0,0.0, .1, .5,.6); c = 2;
end;
...
axis equal;
legend([h0,h2,h3,h4],'LSFS','PCA','LPP','LDA',4);
